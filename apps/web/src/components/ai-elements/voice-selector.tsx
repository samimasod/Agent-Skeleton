...
import {
  ...
  User as MarsIcon,
  HelpCircle as MarsStrokeIcon,
  Fingerprint as NonBinaryIcon,
  Pause as PauseIcon,
  Play as PlayIcon,
  TrendingUp as TransgenderIcon,
  User as VenusAndMarsIcon,
  User as VenusIcon,
} from "lucide-react";
...
export const VoiceSelectorPreview = ({
  ...
  return (
    <Button
      ...
      variant="outline"
      size="sm"
      className={cn("shrink-0 rounded-full size-6", className)}
      disabled={loading}
      onClick={handleClick}
      {...props}
    >
