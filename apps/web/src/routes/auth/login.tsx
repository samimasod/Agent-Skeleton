  ...
  return (
    <Card className="border border-border/80 bg-card/90 backdrop-blur-xl shadow-2xl rounded-2xl overflow-hidden">
      <CardHeader className="text-center space-y-2 border-b border-border/40 pb-6">
        <CardTitle className="text-2xl font-extrabold tracking-tight text-foreground">Sign in to Skeleton</CardTitle>
        <p className="text-xs text-muted-foreground leading-relaxed">
          Access your multi-tenant organization, AI agent builder, and workspace tools.
        </p>
      </CardHeader>
